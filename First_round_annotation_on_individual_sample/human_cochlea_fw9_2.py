...
sc.pl.dotplot(
   ...
   dendrogram=True,
    ...
    save="_cochlea-cell_type_gw11_2_FIRST_ROUND_SCREENING_1.pdf"
)
...
exclude_clusters = ['0','1','2','6','7','12','15','27',]
...
'4': 'CoE_Medial',
 ...
 '17': 'Vestibular_SCs',
     '19': 'Vestibular_SCs',
 '11': 'Vestibular_Epithelial_cells',
     '8': 'Vestibular_Epithelial_cells',
  '22': 'Vestibular_Roof_cells',
    '26': 'Vestibular_HCs',
 '21': 'SGNs',
     '14': 'SGNs',
 '9': 'GCs',
...
sc.pl.correlation_matrix(adata_rm, 'cell_type',
                         save="cell-type-correlation_HUMAN_GW11_2.pdf")
...
sc.pl.umap(adata_rm,color='cell_type',legend_loc='on data',frameon=False, legend_fontsize=5, legend_fontoutline=False,
           title="Human_fetal_cochlea_GW11_2 n=4,051 nuclei",
          save="_HUMAN_GW11_2_CELL_TYPE_ANNO.pdf")
sc.set_figure_params(figsize=(4,4),frameon=False,dpi=150,dpi_save=600)
...
adata_rm.write("human_gw11_2_raw.h5ad")
...
sc.pl.dotplot(
   ...
   dendrogram=True,
    standard_scale="var",  # standard scale: normalize each gene to range from 0 to 1
     save="cochlea-cell_type_refined_human_gw11_2-order.pdf"
)
...
sc.pl.violin(adata_rm, ['n_genes_by_counts'], 
             save="cochlea-cell_type_refined_human_gw11_2_gene_detection.pdf",
...
sc.pl.violin(adata_rm, ['total_counts'], 
             save="cochlea-cell_type_refined_human_gw11_2_total_counts.pdf",
             groupby='cell_type',rotation=90)
...
sc.pl.violin(adata_rm, ['pct_counts_mt'], 
             save="cochlea-cell_type_refined_human_gw11_2_mt_pct.pdf",
             groupby='cell_type',rotation=90)
...
adata_new=adata[adata_gw11.obs.index]
adata_new
...
sc.pl.umap(adata_gw11, color=['cell_type', 
...
adata_new.write("human_gw11_2_rawcounts.h5ad")
...
adata_gw11_coe=adata_gw11[adata_gw11.obs['cell_type'].isin(['CoE_Medial','CoE_Lateral',
...
adata_gw11_coe.write("human_gw11_2_raw_coe.h5ad")
...
sc.set_figure_params(figsize=(4,4),frameon=False,dpi=150,dpi_save=600)
sc.pl.umap(adata_gw11, color=['cell_type', 
                                'DLX5','MSX1','GPR155','ACSL4','CXCR4','UBE2C','JAG1', #DORSAL MARKERS,
                                'OTX1','NR2F2','EDN3','RSPO3', # VENTRAL MARKERS,
