...
adata=sc.read_10x_h5("coch-310_filtered_feature_bc_matrix_gw22.h5")
...
sc.pl.pca(adata_filtered, color=['MYO7A','TMC1','ATOH1','STRC', 'OTOG','OTOGL','SNAP25','MPZ' ] )
...
sc.pl.dotplot(
   ...
   dendrogram=True,
    ...
    save="_cochlea-cell_type_gw22_2_310_FIRST_ROUND_SCREENING_1.pdf"
)
...
'Mast Cells':["PRSS34"],
 ...
 'Surrounding structures':["OSR2","BMP6","SLC7A11","CHRDL1","COL1A1","ALDH1A2"],
    ...
    'Inner_border-phalangeal/Hensen_cells':['S100A1','SLC1A3'],
     ...
     'TypeI_SGN' :['SNAP25','NEFL','TUBB3', 'PVALB','CALB2','LYPD1','RUNX1'],
...
sc.pl.dotplot(
   ...
   dendrogram=True,
    standard_scale="var",  # standard scale: normalize each gene to range from 0 to 1
    save="_cochlea-cell_type_gw22_2_310_FIRST_ROUND_SCREENING_2.pdf"
)
...
#subdivide cluster 17 
sc.tl.leiden(adata_rm, resolution=0.8, restrict_to=('leiden', ['17']))
...
sc.pl.dotplot(
   ...
   dendrogram=True,
    standard_scale="var",  # standard scale: normalize each gene to range from 0 to 1
    save="_cochlea-cell_type_gw22_2_310_FIRST_ROUND_SCREENING_3.pdf"
)
...
sc.pl.dotplot(
   ...
   dendrogram=True,
    standard_scale="var",  # standard scale: normalize each gene to range from 0 to 1
    save="_cochlea-cell_type_gw22_2_310_FIRST_ROUND_SCREENING_4.pdf"
)
...
#subdivide cluster 19 
sc.tl.leiden(adata_rm, resolution=1, restrict_to=('leiden', ['15','21','24','26']))
sc.pl.umap(adata_rm, color='leiden_R',legend_loc='on data')
...
sc.pl.dotplot(
   ...
   dendrogram=True,
    standard_scale="var",  # standard scale: normalize each gene to range from 0 to 1
    save="_cochlea-cell_type_gw22_2_310_FIRST_ROUND_SCREENING_5.pdf"
)
...
'7': 'Chondrocytes',
  ...
  '25': 'Intermediate_stria',
'11': 'Fibrocytes',
'5': 'Osteocytes/Osteoblasts',
 '2': 'Tympanic_border_cells',   
     '16': 'Tympanic_border_cells',  
     '1': 'Tympanic_border_cells',  
     '10': 'Tympanic_border_cells',  
     '20': 'pericytes',
 '17,1': 'Basal_stria',
 '17,0': 'Basal_stria',
 '17,2': 'Basal_stria',
...
'19,2': 'SS',
 '19,3': 'SS',   
'15-21-24-26,7': 'Inner_border-phalangeal/Hensen_cells',
  '15-21-24-26,2': 'Deiters_cells', 
'15-21-24-26,5': 'Deiters_cells',
 '15-21-24-26,3': 'Pillar_cells',
'15-21-24-26,0': 'Claudius/Inner-Outer_sulcus_cells',
'15-21-24-26,1': 'Claudius/Inner-Outer_sulcus_cells',
'15-21-24-26,6': 'Claudius/Inner-Outer_sulcus_cells',
  '15-21-24-26,4': 'Interdental_cells',
 '6': 'Mesenchymal', 
    '8': 'Mesenchymal', 
 '12': 'Mesenchymal', 
...
sc.pl.correlation_matrix(adata_rm, 'cell_type',
                         save="cell-type-correlation_HUMAN_GW22_2_310.pdf")
...
sc.pl.umap(adata_rm,color='cell_type',legend_loc='on data',frameon=False, legend_fontsize=5, legend_fontoutline=False,
           title="Human_fetal_cochlea_GW22_2_310 n=5,837 nuclei",
          save="_HUMAN_GW22_2_310_CELL_TYPE_ANNO.pdf")
sc.set_figure_params(figsize=(4,4),frameon=False,dpi=150,dpi_save=600)
...
adata_rm.write("human_gw22_2_310_raw.h5ad")
...
sc.pl.dotplot(
   ...
   dendrogram=True,
    standard_scale="var",  # standard scale: normalize each gene to range from 0 to 1
     save="cochlea-cell_type_refined_human_gw22_2_310-order.pdf"
)
...
sc.pl.violin(adata_rm, ['n_genes_by_counts'], 
             save="cochlea-cell_type_refined_human_gw22_2_310_gene_detection.pdf",
...
sc.pl.violin(adata_rm, ['total_counts'], 
             save="cochlea-cell_type_refined_human_gw22_2_310_total_counts.pdf",
             groupby='cell_type',rotation=90)
...
sc.pl.violin(adata_rm, ['pct_counts_mt'], 
             save="cochlea-cell_type_refined_human_gw22_2_310_mt_pct.pdf",
             groupby='cell_type',rotation=90)
...
adata_rm=sc.read("human_gw22_2_310_raw.h5ad")
adata_rm
...
adata_new.write("human_gw22_2_310_rawcounts.h5ad")
...
adata_gw22_coe.write("human_gw22_2_310_raw_coe.h5ad")
