...
adata=sc.read("Hu_GW17_python.h5ad")
...
adata.write("human_gw17_raw.h5ad")
...
sc.pl.dotplot(
   ...
   dendrogram=True,
    ...
    save="_cochlea-cell_type_gw17_FIRST_ROUND_SCREENING_1.pdf"
)
...
sc.pl.dotplot(
   ...
   dendrogram=True,
    standard_scale="var",  # standard scale: normalize each gene to range from 0 to 1
    save="_cochlea-cell_type_gw17_FIRST_ROUND_SCREENING_2.pdf"
)
...
exclude_clusters = ['0','1','2','3','5','7','8','10','12','14','17','18','19','24','21','20']
...
#subdivide cluster 29 for SMC AND PERICYTES
sc.tl.leiden(adata_rm, resolution=0.8, restrict_to=('leiden', ['29']))
...
sc.pl.dotplot(
   ...
   dendrogram=True,
    standard_scale="var",  # standard scale: normalize each gene to range from 0 to 1
    save="_cochlea-cell_type_gw17_FIRST_ROUND_SCREENING_3.pdf"
)
...
sc.pp.neighbors(adata_rm, n_neighbors=30, n_pcs=60)
...
sc.pl.correlation_matrix(adata_rm, 'cell_type',
                         save="cell-type-correlation_HUMAN_GW17.pdf")
...
sc.pl.umap(adata_rm,color='cell_type',legend_loc='on data',frameon=False, legend_fontsize=5, legend_fontoutline=False,
           title="Human_fetal_cochlea_GW17 n=4,538 nuclei",
          save="_HUMAN_GW17_CELL_TYPE_ANNO.pdf")
sc.set_figure_params(figsize=(4,4),frameon=False,dpi=150,dpi_save=600)
...
adata_rm.write("human_gw17_raw.h5ad")
...
sc.pl.dotplot(
   ...
   dendrogram=True,
    standard_scale="var",  # standard scale: normalize each gene to range from 0 to 1
     save="cochlea-cell_type_refined_human_gw17-order.pdf"
)
...
sc.pl.violin(adata_rm, ['n_genes_by_counts'], 
             save="cochlea-cell_type_refined_human_gw17_gene_detection.pdf",
...
sc.pl.violin(adata_rm, ['total_counts'], 
             save="cochlea-cell_type_refined_human_gw17_total_counts.pdf",
             groupby='cell_type',rotation=90)
...
sc.pl.violin(adata_rm, ['pct_counts_mt'], 
             save="cochlea-cell_type_refined_human_gw17_mt_pct.pdf",
             groupby='cell_type',rotation=90)
...
adata_rm=sc.read("human_gw17_raw.h5ad")
adata_rm
...
adata_new.write("human_gw17_rawcounts.h5ad")
...
adata_gw17_coe=adata_rm[adata_rm.obs['cell_type'].isin(['SCs','HCs',
...
adata_gw17_coe.write("human_gw17_raw_coe.h5ad")
